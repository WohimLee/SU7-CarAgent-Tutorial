...
在车载场景里，意图分类建议不要按「NLP 教科书」那种太细的分类，而是直接对应你要调的子图 / Agent / 工具。
...
一般由业务/产品/运营和技术团队设计，并不是规定死的，而且后续需要迭代更新
...
推荐用一个统一的结构，方便 LangGraph 用 conditional_edges 分流：
```py
{
